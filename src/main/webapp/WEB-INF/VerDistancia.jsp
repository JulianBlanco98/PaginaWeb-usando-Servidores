...
<head>
<meta charset="UTF-8">
<title>RutasExtremadura Distancia</title>
...
<body>
	...
	<header>
		...
		<img src="./img/Distancia/dis.png" class="tit"> <a
	...
	<div id="contenedor">
		...
		<%
		ArrayList listaDistancia = (ArrayList) request.getAttribute("listaDis");
		%>

		<%
		for (int i = 0; i < listaDistancia.size(); i++) {
			Ruta ruta = (Ruta) listaDistancia.get(i);
		%>
		<div class="recubrir">
			<div class="carta">
				...
				<div class="carta-datos">
					<div class="carta-header"><%=ruta.getNombreRuta()%> (<%=(i+1) %>)</div>
